...
//以下所有对象都导出
const 护卫舰=new ship('护卫舰',1,null,-1,sprite护卫舰,100,50,300,{x:0,y:0},10,0.6,200,0)
const 驱逐舰=new ship('驱逐舰',2,null,-1,sprite驱逐舰,300,200,600,{x:0,y:0},15,0.4,175,0)
const 巡洋舰=new ship('巡洋舰',4,null,-1,sprite巡洋舰,500,500,1000,{x:0,y:0},25,0.3,150,0)
const 战列舰=new ship('战列舰',8,null,-1,sprite战列舰,750,1000,1500,{x:0,y:0},30,0.2,100,0)
const 星域堡垒ship=new ship('星域堡垒',16,null,-1,sprite堡垒,2500,2500,2000,{x:51199,y:51199},45,0,0,0)//位于中间
